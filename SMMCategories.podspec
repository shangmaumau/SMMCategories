#
#  Be sure to run `pod spec lint SMMCategories.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #  spec.description  = <<-DESC "Some useful Categories for iPhoneOS deverlopment."
                   #DESC
  ...
  # Or just: spec.author    = "尚毛毛"
  # spec.authors            = { "尚毛毛" => "shangmaomao@xiaoniuhy.com" }
  # spec.social_media_url   = "https://twitter.com/尚毛毛"
  ...
  # spec.exclude_files = "SMMCategories/"
